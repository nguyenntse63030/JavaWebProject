...
public class LoginServlet extends HttpServlet {
    ...
    private final String showMarkTable = "showMarkTable";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (result) {
                url = showMarkTable;
                String studentName = dao.searchNameStudent(username);
                String studentFullName = dao.searchFullNameStudent(username);
